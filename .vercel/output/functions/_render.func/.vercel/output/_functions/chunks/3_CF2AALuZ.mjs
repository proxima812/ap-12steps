const id = "3.md";
						...
						const data = {title:"Не судите по одной группе! АП (АПРО) - это не одна группа.",description:"\"Главное принципы, а не личности\" - 12 традиция",datePublished:"2024-10-29T11:30:00Z"};
						const _internal = {
							type: 'content',
							filePath: "/Users/samgold/Desktop/Проекты/a_procrastionations/src/content/posts/3.md",
							rawData: undefined,
						};
